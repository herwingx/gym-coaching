      ...
      components={{
        ...
        Dropdown: ({ value, onChange, options, ...props }: DropdownProps) => {
          ...
          return (
            ...
            >
              <SelectTrigger className="h-8 w-fit font-medium border-none hover:bg-accent hover:text-accent-foreground focus:ring-0 focus:ring-offset-0 px-2 py-1 bg-transparent">
