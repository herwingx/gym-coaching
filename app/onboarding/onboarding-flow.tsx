...
const FITNESS_GOALS: {
  ...
  },
  {
    value: "maintain",
    label: "Mantenerme",
    description: "Conservar mi forma actual",
  },
  { value: "strength", label: "Fuerza", description: "Ser más fuerte" },
  {
    value: "endurance",
    label: "Resistencia",
    description: "Mejorar mi cardio",
  },
];
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.error(
          result.error || "No pudimos guardar tus datos. Intenta de nuevo.",
        );
      }
    } catch (err) {
            ...
            return (
              ...
              >
                ...
                {index < STEPS.length - 1 && (
                  <div
                    className={`flex-1 h-0.5 ${isComplete ? "bg-primary" : "bg-muted"}`}
                  />
                )}
              </div>
            );
              ...
              <CardContent className="space-y-6">
                <div className="text-center py-6">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Te enviaremos recordatorios para que no pierdas tu racha en
                    RU Coach
                  </p>
