    ...
    <>
      ...
      <div className={`${CLIENT_DATA_PAGE_SHELL} flex flex-col gap-8`}>
          ...
          <Card className="overflow-hidden border-muted/70 shadow-none">
            <CardHeader className="flex flex-col gap-1 pb-2 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <CardDescription>
                  {levelName} · nivel {levelInfo.level} · experiencia acumulada
                  en la app
                </CardDescription>
              </div>
              <Badge
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                ...
                <Card className="border-muted/60 bg-muted/15 shadow-none">
                  ...
                  <CardContent className="p-4 pt-0">
                    ...
                    <p className="mt-1 text-[11px] text-muted-foreground">
                      Entrenos consecutivos con registro
                    </p>
                  </CardContent>
                </Card>
              </div>
          ...
          <section className="flex flex-col gap-4" aria-label="Últimos hitos">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Los más recientes que completaste
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              {recentlyUnlocked.map((ua) => (
                <Card
                  key={ua.id}
                  className="border-muted/70 shadow-none transition-shadow hover:shadow-md"
                >
        ...
        <section className="flex flex-col gap-4" aria-label="Catálogo de hitos">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Filtra por tipo y revisa el objetivo de cada uno
              </p>
            </div>
          </div>
          <AchievementsCatalog
        ...
        {leaderboard.length > 0 && (
          <section
            className="flex flex-col gap-4"
            aria-label="Actividad en el gym"
          >
            <div className="flex items-center gap-2">
              <div className="flex size-9 items-center justify-center rounded-lg bg-muted">
              ...
              <div>
                <h2 className="text-base font-semibold tracking-tight">
                  Compañeros con más actividad
                </h2>
                <p className="text-xs text-muted-foreground">
                  Ranking por XP y logros en la plataforma
                </p>
              </div>
            </div>
            <Card className="overflow-hidden border-muted/70 shadow-none">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="truncate text-sm font-semibold">
                            ...
                            {entry.id === user.id && (
                              <Badge
                                variant="secondary"
                                className="ms-2 align-middle text-[10px] font-medium"
                              >
                                Tú
                              </Badge>
                            )}
        ...
        <Alert className="border-muted/70">
          ...
          <AlertDescription className="text-xs leading-relaxed text-pretty">
            Completar entrenos, mantener rachas y registrar marcas personales
            suman XP automáticamente. Cada hito desbloqueado añade su recompensa
            y refleja hábitos reales — no puntos artificiales por usar la app.
          </AlertDescription>
        </Alert>
      </div>
    </>
