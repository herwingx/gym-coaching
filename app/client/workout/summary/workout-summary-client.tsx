      ...
      <aside className="flex flex-col gap-6 lg:sticky lg:top-[max(1rem,env(safe-area-inset-top))] lg:col-span-5 lg:self-start">
        <Card className="overflow-hidden border-border/80 shadow-sm ring-1 ring-primary/5">
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Récords registrados en esta sesión (logs)
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="overflow-hidden border-border/80 shadow-sm ring-1 ring-primary/5">
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Actualizamos los pesos sugeridos de este día según tus PRs y
              límites (se respeta dolor fuerte activo).
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col gap-4">
            {progressionPhase === "no_day" ? (
              <p className="text-sm text-muted-foreground text-pretty">
                Esta sesión no está vinculada a un día de rutina; no hay
                sugerencias que actualizar aquí.
              </p>
            ) : null}
                ...
                <div className="flex items-start gap-3 rounded-xl border border-primary/25 bg-primary/5 px-4 py-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground text-pretty">
                      La próxima vez que hagas este día, verás los pesos
                      sugeridos alineados con tu último rendimiento.
                    </p>
                  </div>
                </div>
                <Button
            ...
            {progressionPhase === "manual" ? (
              <div className="flex flex-col gap-4">
                <p className="text-sm text-muted-foreground text-pretty">
                  Tienes desactivada la actualización automática. Puedes aplicar
                  ahora o activar el interruptor abajo para que se haga sola al
                  terminar cada entreno.
                </p>
                <Button
                  type="button"
              ...
              <label className="flex items-start justify-between gap-4 border-t border-border/60 pt-4">
                <div className="min-w-0">
                  <div className="text-sm font-medium">
                    Actualizar sugerencias al cerrar el entreno
                  </div>
                  <div className="text-sm text-muted-foreground text-pretty">
                    Activado: se aplican solas al abrir este resumen.
                    Desactivado: tú pulsas aplicar (útil en descargas o si el
