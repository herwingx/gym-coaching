              ...
              <div className="flex flex-col items-center gap-4 text-center md:items-start md:text-left">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-balance text-muted-foreground">
                    Casi has terminado. Hemos enviado un enlace de verificación
              ...
              <div className="space-y-4">
                <div className="rounded-xl border bg-muted/30 p-6 space-y-4">
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Por favor, haz clic en el enlace del email para verificar tu
                    cuenta y poder acceder a tu plan de entrenamiento.
                  </p>
                  <p className="text-xs text-muted-foreground italic">
                    Si no ves el email en tu bandeja de entrada, recuerda
